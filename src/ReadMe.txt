========================================================================
		ActiveX Control DLL : SHORTCUT
========================================================================

ControlWizard has created this project for your SHORTCUT ActiveX Control
...
that make up your SHORTCUT ActiveX Control DLL.
...
ShortcutCtl.h
	This file contains the declaration of the CShortcutCtrl C++ class.

ShortcutCtl.cpp
	This file contains the implementation of the CShortcutCtrl C++ class.

ShortcutPpg.h
	This file contains the declaration of the CShortcutPropPage C++ class.

ShortcutPpg.cpp
	This file contains the implementation of the CShortcutPropPage C++ class.

ShortcutCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CShortcutCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Shortcut.rc.
